...
function InstagramIcon() {
  return (
    <svg aria-hidden="true" viewBox="0 0 1024 1024" fill="none" className="size-5">
...
const EXPLORE_LINKS = [
  ...
  { label: "Últimos partidos", href: "/#partidos" },
  { label: "Nuestros recuerdos", href: "/#recuerdos" },
] as const;
    ...
    <footer className="bg-primary py-12 text-white">
      <div className="wrap">
        <div className="grid gap-10 border-b border-white/20 pb-12 md:grid-cols-[2fr_1fr_1fr]">
          ...
          <div>
            <p className="eyebrow mb-5 text-secondary">Explora</p>
          ...
          <div>
            <p className="eyebrow mb-5 text-secondary">Sigamos conectadas</p>
            <nav aria-label="Comunidad" className="grid gap-3 text-base">
              <Link href="/#redes" className="hover:underline">Nos vemos en redes</Link>
              <Link href="/#faq" className="hover:underline">Preguntas frecuentes</Link>
              <Link href="/#contacto" className="flex items-center gap-2 hover:underline">
        ...
        <div className="flex flex-col items-center gap-4 pt-7 text-center text-sm text-white md:flex-row md:justify-between md:text-left">
          ...
          <nav aria-label="Redes sociales" className="flex items-center gap-3">
            <Link
              href="https://www.facebook.com/profile.php?id=61591538154552"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Facebook de Chicas SC"
              className="grid size-8 place-items-center rounded-full transition-colors hover:bg-white hover:text-primary"
            >
              <FacebookIcon />
            </Link>
            <Link
              href="https://www.instagram.com/chicassc_oficial/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Instagram de Chicas SC"
              className="grid size-8 place-items-center rounded-full transition-colors hover:bg-white hover:text-primary"
            >
              <InstagramIcon />
            </Link>
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="TikTok de Chicas SC"
              className="grid size-8 place-items-center rounded-full transition-colors hover:bg-white hover:text-primary"
            >
              <TikTokIcon />
            </Link>
